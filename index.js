...
function validateAndFormatGender(genderInput) {
...
function validateAndFormatBodyFat(fatPercentage) {
...
function validateAndFormatState(stateInput) {
 ...
 ***        ПОДСЧЁТ СТОИМОСТИ       ****
****************************************/
// Есть следующий словарь цен в зависимости от калорий (для мужчин)
...
function getPriceBasedOnCaloriesAndGender(calories, gender) {
...
function calculateAndDisplayPrice(userId) {
